...
exports.config = {
    ...
    services: [
        ...
        // The options
        {
            ...
            baselineFolder: join(process.cwd(), './visualTesting/baseLineScreenshot/'),
            formatImageName: '{tag}',
            screenshotPath: join(process.cwd(), './visualTesting/tmp/results/'),
    ...
    //
    specs: [
        './test/features/loginpage.feature',
    ],
    // Patterns to exclude.
    exclude: [
